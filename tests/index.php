...
$case['descr'] = 'Комментарии. Хитрый случай';
...
$case['descr'] = 'LESS CSS. Nested rules';
$case['code'] = '#header {
    color: black;
...
$case['descr'] = 'LESS CSS. Operations';
$case['code'] = 'div{
    @base: 5%;
    @filler: @base * 2;
    @other: @base + @filler;
...
$case['descr'] = 'LESS CSS. Namespaces & Accessors';
$case['code'] = '#bundle {
    .button {
        display: block;
...
$case['descr'] = 'Примеры реальных файлов. http://pepelsbey.net/wp-content/themes/pepelsbey/s/screen.css 2011/01/18';
...
$case['descr'] = 'Тестрование окружения. Скармливаем просто свойства';
$case['code'] = 'color:red;
position:relative;
...
$case['descr'] = 'Тестрование окружения. Скармливаем HTML содержащий аттрибут style';
$case['code'] = '<p style="padding-left:0;padding-top:0;margin-right:0;margin-top:0;">бла-бла-бла</p>';
$case['result'] = '<p style="margin-top:0;margin-right:0;padding-top:0;padding-left:0;">бла-бла-бла</p>';
$testcases[] = $case;


$case['descr'] = 'Тестрование окружения. Скармливаем HTML содержащий несколько аттрибутов style';
$case['code'] = '<p style="padding-left:0;padding-top:0;margin-right:0;margin-top:0;">бла-бла-бла</p>
<p style="padding-left:1px;padding-top:2px;margin-right:3px;margin-top:4px;">бла-бла-бла</p>';
$case['result'] = '<p style="margin-top:0;margin-right:0;padding-top:0;padding-left:0;">бла-бла-бла</p>
<p style="margin-top:4px;margin-right:3px;padding-top:2px;padding-left:1px;">бла-бла-бла</p>';
$testcases[] = $case;
...
$case['descr'] = 'Тестрование окружения. Скармливаем HTML содержащий тег style';
...
$case['descr'] = 'Тестрование окружения. Скармливаем HTML содержащий несколько тегов style';
$case['code'] = '<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
/* Порядок сортировки */
$case['descr'] = 'Кастомный порядок сортировки. В коде уже есть разделение на группы.';
$case['code'] = 'div{
    position:absolute;
    top:0;
    left:0;
